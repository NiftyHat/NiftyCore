...
namespace UnityEditor
{
    public class PopupList : PopupWindowContent
    {
        ...
        public string _test;
        static string s_TextFieldName = "NiftyPopupList";
        ...
        private class Styles
        {
            ...
            public Styles()
            {
                ...
                customTextFieldCancelButton = new GUIStyle(NiftyEditor.GetStyle("ToolbarSeachCancelButton"));
                customTextFieldCancelButtonEmpty = new GUIStyle(NiftyEditor.GetStyle("ToolbarSeachCancelButtonEmpty"));
            }
        }
        ...
        private void DrawCustomTextField(EditorWindow editorWindow, Rect windowRect)
        {
            ...
            // Draw textfield
            {
                ...
                int id = GUIUtility.GetControlID(s_TextFieldHash, FocusType.Keyboard, pos);
            ...
            if (textBeforeEdit != textFieldText)
            {
                ...
                //m_EnteredText = (0 <= textEditor.cursorIndex && textEditor.cursorIndex < textFieldText.Length) ? textFieldText.Substring(0, textEditor.cursorIndex) : textFieldText;
                //m_EnteredText = textFieldText.Substring(0, s_RecycledEditor.cursorIndex) : textFieldText;
        ...
        private void AdjustRecycledEditorSelectionToCompletion()
        {
            if (m_EnteredTextCompletion != "")
            {
                ...
                textEditor.text = m_EnteredTextCompletion;
                //EditorGUI.s_OriginalText = m_EnteredTextCompletion;
                textEditor.cursorIndex = m_EnteredText.Length;
                textEditor.selectIndex = m_EnteredTextCompletion.Length; //the selection goes from s_RecycledEditor.cursorIndex (already set by DoTextField) to s_RecycledEditor.selectIndex
            }
        }
